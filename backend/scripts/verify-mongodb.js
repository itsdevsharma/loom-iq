...
async function main() {
  ...
  try {
    ...
    const credentials = { name: 'Database verification', company: 'LoomIQ verification', phone: '1234567890', address: 'Verification Road', city: 'Surat', state: 'Gujarat', email: 'mongo-verification@example.invalid', password: crypto.randomBytes(20).toString('hex'), acceptTerms: true, formStartedAt: Date.now() - 5000 };
