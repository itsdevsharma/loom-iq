...
async function signup(email) { const visit = await post('/api/offers/visit', {}); return post('/api/account/signup', { name: 'Tester', company: 'Acme', phone: '1234567890', address: 'Road', city: 'City', state: 'State', email, password: 'Test-password-123', acceptTerms: true, formStartedAt: Date.now() - 5000 }, visit.cookie); }
