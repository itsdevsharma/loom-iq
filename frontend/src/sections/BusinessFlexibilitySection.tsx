...
const useCases = cmsValue("BusinessFlexibilitySection.1", [
    ...
    <section id="industries" className="section section-shell section-flexibility">
      <div className="flexibility-inner">
        <div className="section-heading">
          <p className="eyebrow">{cmsValue("BusinessFlexibilitySection.2", "Flexible ERP for different business types")}</p>
          <h2>{cmsValue("BusinessFlexibilitySection.3", "One ERP system built around how your business works.")}</h2>
          <p>{cmsValue("BusinessFlexibilitySection.4", " Whether you manage production, inventory, retail operations, or a growing commercial workflow, LoomIQ keeps sales, operations, and finance connected from one source of truth. ")}</p>
        </div>
