...
const valuePoints = cmsValue("ValueSection.1", [
    ...
    <section id="value" className="section section-shell section-value">
      <div className="value-inner">
        <div className="section-heading">
          <p className="eyebrow">{cmsValue("ValueSection.2", "Why LoomIQ")}</p>
          <h2>{cmsValue("ValueSection.3", "Built around the way cloth manufacturers work.")}</h2>
          <p>{cmsValue("ValueSection.4", " One operating system for commercial teams, stores, production, quality, dispatch, and accounts — without forcing the factory into a generic workflow. ")}</p>
        </div>
