...
export function cmsValue<T>(key: string, fallback: T): T {
  ...
  const prices = (content['Site.pricing'] || {Starter:{firstMonth:1195,recurring:2390},Growth:{firstMonth:1695,recurring:3390},Enterprise:{recurring:4990}}) as ReturnType<typeof websitePricing>
